...
public class PaintManager implements Listener, UserInventoryInteractListener {
  ...
  public static final ExItemStack PAINT_BALL = new ExItemStack(Material.EGG).setDropable(false)
      .setDisplayName(
          "§6Paint Ball");
  ...
  public static void drawCircle(GraffitiUser user, Block center, Location origin, double radius,
    ...
    Server.runTaskAsynchrony(() -> {
      ...
      Map<Material, Material> paintMap = white ? WHITE_PAINT_MAP :
          user.getTeam().equals(GraffitiServer.getGame().getBlueTeam()) ? BLUE_PAINT_MAP
              : RED_PAINT_MAP;
  ...
  public static final ExItemStack BLUE_SPRAY_BOTTLE = new ExItemStack(Material.BLUE_DYE)
      .setDisplayName("§9Blue Spray Bottle")
      .setLore("", "§fDamage: §7" + SPRAY_DAMAGE / 2 + " ❤", "§fPaint: §7"
  ...
  public static final ExItemStack RED_SPRAY_BOTTLE = new ExItemStack(Material.RED_DYE)
      .setDisplayName("§cRed Spray Bottle")
      .setLore("", "§fDamage: §7" + SPRAY_DAMAGE / 2 + " ❤", "§fPaint: §7"
